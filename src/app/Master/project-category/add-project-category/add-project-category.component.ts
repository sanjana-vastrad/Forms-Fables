...
export class AddProjectCategoryComponent implements OnChanges {
  ...
  submitForm(): void {
    if (this.categoryForm.valid) {
      ...
      if (this.categoryToEdit) {
        // Update
        this.apiService.updateProjectCategory(this.categoryToEdit.id, payload).subscribe({
          next: () => {
            this.loading = false;
        ...
        // Create
        this.apiService.createProjectCategory(payload).subscribe({
          next: () => {
            this.loading = false;
